...
! v.3.x ES MAS RAPIDO QUE EL ANTERIOR AL MEJORAR LA PRUEBA DE PRIMALIDAD COMPROBANDO HASTA LA
! RAIZ CUADRADA DEL NUMERO Y ESTA VEZ DETENIENDOSE SI EL NUMERO NO ES PRIMO.
program p
implicit none
